              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">{2024} • {formatFileSize(file.document.size)}</p>
                  </div>
                </div>
                <Button variant="ghost" size="icon" className="flex-shrink-0 cursor-pointer" onClick={() => handleDownload(file.document.url)}>
