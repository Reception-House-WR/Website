...
const programs = [
  {
    ...
    description:
      "Immediate support when newcomers first arrive in Canada, ensuring a stable foundation for their new life.",
    services: [
  ...
  },
  {
    ...
    description:
      "Long-term integration support helping newcomers build independent, fulfilling lives in their new community.",
    services: [
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            We provide comprehensive support through two main programs, each
            designed to meet newcomers at their specific stage of settlement and
            help them thrive.
          </p>
        </div>
        ...
        <div className="mt-12 text-center max-w-3xl mx-auto">
          <p className="text-lg text-foreground leading-relaxed">
            These programs go beyond meeting basic needs they restore dignity,
            build confidence, and create pathways to independence. Every person
            who walks through our doors deserves a chance to rebuild their life
            with support, respect, and hope for the future.
          </p>
        </div>
      </div>
    </section>
