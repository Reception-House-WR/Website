        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg leading-relaxed text-muted-foreground mb-8">
              Finding housing is one of the most critical challenges newcomers
              face. Reception House works closely with landlords and property
              managers throughout Waterloo Region to ensure refugees and
              immigrants have access to safe, affordable housing as they build
      ...
      <section className="py-10">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Comprehensive support services to help newcomers find and maintain
            stable housing
          </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl leading-relaxed text-muted-foreground mb-8">
                Landlords who partner with Reception House gain reliable,
                supported tenants and contribute to building a more inclusive
                community. Our team provides ongoing support to both tenants and
                landlords, ensuring successful, long-term rental relationships.
              </p>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Our clients are committed to building stable lives and
                    maintaining positive rental relationships
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-primary text-primary-foreground flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Reception House staff provide continued assistance to ensure
                    smooth tenancies
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Help newcomers integrate and contribute to our diverse,
                    vibrant region
                  </p>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    Access to professional support if any issues arise during
                    tenancy
                  </p>
                </li>
              </ul>
