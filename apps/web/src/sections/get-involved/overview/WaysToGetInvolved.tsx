        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <Card className="shadow-medium hover:shadow-strong transition-shadow group">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{volunteerCard.title}</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
                {volunteerCard.description}
              </p>
              <Button
                asChild
          ...
          <Card className="shadow-medium hover:shadow-strong transition-shadow group">
            <CardContent className="p-8">
              ...
              <h3 className="text-2xl font-bold mb-4">{rentCard.title}</h3>
              <p className="text-muted-foreground mb-6 leading-relaxed">
